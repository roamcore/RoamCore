...
- **Install (HA-only beta):** `docs/howto/homeassistant-installer.md`
...
- **Entity naming convention:** `docs/reference/rc-entity-naming.md`
- **OpenClaw JSON API contract:** `docs/reference/openclaw-json-api.md`
