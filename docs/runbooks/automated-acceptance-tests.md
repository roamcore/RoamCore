...
### Gate C — dashboard reliability

Once your Hub is installed and your devices are connected, the dashboard
is the part of RoamCore you look at every day. This test makes sure the
dashboard stays the same shape on your phone as on your tablet, that the
readings update on their own without you doing anything, that a control
you tap in the app actually flips the real switch in the van, and that
anything you have added to the dashboard stays put even when the Hub
restarts. If the test ever fails, the team sees a plain-English message
naming which part of the dashboard is misbehaving and fixes it before any
release reaches your Hub — so you can trust what you see on the screen.
