...
<div class="rc-feature-list">
  <a class="rc-feature" href="leveling/"><div class="rc-feature-left"><div class="rc-feature-title">Levelling sensor (pitch/roll + “are we level?”)</div><div class="rc-feature-sub">RoamCore defines a levelling contract (`rc_level_*`) and supports pitch/roll sensors so the dashboard can show an easy levelling status.</div></div></a>
</div>
