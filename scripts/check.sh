...
run_if_present "connections/frigate/tests/test_connection_yml.py" \
  "Connection: Frigate (NVR + on-device object detection, tier-b) — vendor-neutral CCTV backend with person/car/animal/package contract: manifest honesty smoke check"
