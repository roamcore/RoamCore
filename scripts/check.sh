...
run_if_present "connections/ha-installer/tests/test_connection_yml.py" \
  "Connection: HA installer (one-line installer + uninstaller + idempotent guard + RC_API_TOKEN-aware wiring) (tier-a) — manifest honesty smoke check"
