...
run_if_present "connections/trip-local/tests/test_connection_yml.py" \
  "Connection: Trip Local (tier-a) — vendor-neutral local-first trip metrics from the HA recorder (distance / drive time / stops): manifest honesty smoke check"
