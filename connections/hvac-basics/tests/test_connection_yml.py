...
def test_category_matches_existing_legacy_doc(manifest: dict) -> None:
    ...
    legacy_text = LEGACY_DOC.read_text(encoding="utf-8")
    assert "Moved" in legacy_text and "connections/hvac-basics/docs/recipe.md" in legacy_text, (
        "legacy docs/catalog/hvac/hvac-basics.md must be a 2-line 'Moved to ...' redirect page pointing at "
        "connections/hvac-basics/docs/recipe.md (Wave 9 #124c); got:\n" + legacy_text[:200]
    )
    ...
    assert "SUPERSEDED" not in legacy_text, (
        "legacy docs/catalog/hvac/hvac-basics.md must not carry the 'SUPERSEDED' banner (Wave 9 "
