...
def test_category_matches_existing_legacy_doc(manifest: dict) -> None:
    ...
    assert "Moved" in legacy_text and "connections/teltonika/docs/recipe.md" in legacy_text, (
        "legacy docs/catalog/networking/teltonika.md must be a 2-line "
        "'Moved to ...' redirect page pointing at "
        "connections/teltonika/docs/recipe.md (Wave 9 #124c); got:\n"
        + legacy_text[:200]
    )
    ...
    assert "SUPERSEDED" not in legacy_text, (
        "legacy docs/catalog/networking/teltonika.md must not carry the "
