...
- `docs/catalog/map/map-dashboard.md` (legacy catalog page — appended SUPERSEDED banner; legacy tier-a claim preserved as aspirational with a footnote pointing at the new connection).
