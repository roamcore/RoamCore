...
- Legacy catalog page (now superseded by this slice): [`docs/catalog/map/amenities-overlay.md`](../../docs/catalog/map/amenities-overlay.md)
...
- RoamCore TileServer add-on (the optional offline POI cache — Wave 2 catalog #21): `docs/catalog/map/roamcore-tileserver-addon.md`
