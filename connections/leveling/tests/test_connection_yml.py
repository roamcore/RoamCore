...
def test_category_matches_existing_legacy_doc(manifest: dict) -> None:
    ...
    assert "Moved" in legacy_index_text and "connections/leveling/docs/recipe.md" in legacy_index_text, (
        "legacy docs/catalog/level-sensor/leveling.md must be a 2-line "
        "'Moved to ...' redirect page pointing at "
        "connections/leveling/docs/recipe.md (Wave 9 #124b); got:\n"
    ...
    assert "SUPERSEDED" not in legacy_index_text, (
        "legacy docs/catalog/level-sensor/leveling.md must not "
