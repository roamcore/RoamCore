...
def test_category_matches_existing_legacy_doc(manifest: dict) -> None:
    ...
    assert "Moved" in legacy_index_text and "connections/openclaw-api/docs/recipe.md" in legacy_index_text, (
        "legacy docs/catalog/ai/openclaw-json-api.md must be a 2-line "
        "'Moved to ...' redirect page pointing at "
        "connections/openclaw-api/docs/recipe.md (Wave 9 #124c); got:\n"
    ...
    assert "SUPERSEDED" not in legacy_index_text, (
        "legacy docs/catalog/ai/openclaw-json-api.md must not carry the "
