    ...
    def status_dict(self) -> dict[str, Any]:
        ...
        return {
            "config": {
                ...
                "victron_host": self.victron_host,
                "victron_port": int(self.victron_port_tls if self.victron_use_tls else self.victron_port),
                "victron_portal_id_configured": bool(self.victron_portal_id),
                "victron_portal_id": self.victron_portal_id,
